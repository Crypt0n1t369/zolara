 ...
 */
export async function getAdminProjects(adminTelegramId: number): Promise<
  Array<{
    id: string;
    name: string;
    status: string | null;
 ...
 */
export async function getActiveProject(adminTelegramId: number): Promise<{
  ...
  if (stored) {
    const data = JSON.parse(stored) as { projectId: string; selectedAt: string };
 ...
 */
export async function setActiveProject(adminTelegramId: number, projectId: string): Promise<void> {
 ...
 */
export async function clearActiveProject(adminTelegramId: number): Promise<void> {
  await redis.del(`active_project:${adminTelegramId}`);
}
 ...
 */
export function buildProjectSelectorText(
  projects: Awaited<ReturnType<typeof getAdminProjects>>,
 ...
 */
export function buildProjectSelectorKeyboard(
  projects: Awaited<ReturnType<typeof getAdminProjects>>,
  context: string,
  prefix: string = 'proj'
