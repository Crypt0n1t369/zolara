 ...
 */
import { pgTable, uuid, text, timestamp, serial, integer, index, } from 'drizzle-orm/pg-core';
...
export const problemDefinitionVotes = pgTable('problem_definition_votes', {
    ...
    problemDefinitionId: uuid('problem_definition_id').references(() => problemDefinitions.id, { onDelete: 'cascade' }),
