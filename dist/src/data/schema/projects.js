import { pgTable, uuid, text, bigint, jsonb, timestamp, boolean, serial, integer, index, } from 'drizzle-orm/pg-core';
...
export const users = pgTable('users', {
    ...
    communicationProfile: jsonb('communication_profile').$type().default({}),
    createdAt: timestamp('created_at').defaultNow(),
    updatedAt: timestamp('updated_at').defaultNow(),
});
export const members = pgTable('members', {
    ...
    projectProfile: jsonb('project_profile').$type().default({}),
...
export const reports = pgTable('reports', {
    ...
    structuredData: jsonb('structured_data').$type().notNull(),
    telegramMessageId: bigint('telegram_message_id', { mode: 'number' }),
    reactions: jsonb('reactions').$type().default({}),
    createdAt: timestamp('created_at').defaultNow(),
});
