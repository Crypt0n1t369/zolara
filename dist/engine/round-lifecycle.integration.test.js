...
import { getMinimumResponses, meetsMinimumThreshold, } from './synthesis/pipeline';
describe('Phase 0 — Round Lifecycle Integration', () => {
    ...
    describe('Anonymity inheritance', () => {
        it('round-level anonymity overrides project config', () => {
            ...
            const projectConfig = { anonymity: 'full' };
        ...
        it('defaults to optional when neither is set', () => {
            const projectConfig = {};
            const roundOverride = null;
            expect(roundOverride ?? projectConfig['anonymity'] ?? 'optional').toBe('optional');
        });
    });
