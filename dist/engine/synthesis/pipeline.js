...
import { responses, questions, members } from '../../data/schema/projects';
...
async function extractThemes(responses, topic) {
...
async function mapAlignment(themes, responseCount) {
...
function extractActionItems(reportText) {
 ...
 */
export function getMinimumResponses(teamSizeRange) {
    const thresholds = {
        '2-5': 2,
        '6-12': 3,
        '13-30': 5,
 ...
 */
export function meetsMinimumThreshold(responseCount, memberCount, teamSizeRange) {
    if (memberCount === 0)
        return false;
